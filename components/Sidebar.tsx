...
import { LayoutDashboard, Users, Award, FileText, Menu, X, Archive } from "lucide-react";
    ...
    <div className="flex flex-col h-full bg-[#1E3A8A] text-white">
      ...
      <nav className="flex-1 px-3 mt-2 space-y-1">
        ...
        <Link
          ...
          onClick={onClose}
          className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-colors text-xs font-medium ${
            isActive('/employees/archive')
              ? "bg-white/20 text-white"
