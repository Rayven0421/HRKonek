...
function ConvertToEmployeeModal({
  ...
  function validate() {
    ...
    if (form.startDate && form.startDate.split('-')[0].length > 4) newErrors.startDate = 'Year must be 4 digits';
    setErrors(newErrors);
          ...
          <div className="space-y-5">
            ...
            <div className="border-t border-gray-100 pt-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <FormField label="Start Date" type="date" value={form.startDate} onChange={v => {
